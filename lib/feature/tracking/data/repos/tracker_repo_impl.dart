...
class TrackerRepoImpl implements TrackerRepo {
  ...
  @override
  Future<Either<FirebaseErrorHandler, List<RoutineModel>>> fetchRoutine(
      {required String skinType, required String routineType}) async {
    try {
      ...
      return right(snapshot.docs
          .map((doc) => RoutineModel.fromJson(doc.id, doc.data()))
          .toList());
  ...
  @override
  Future<Either<FirebaseErrorHandler, void>> updateStepDone(
